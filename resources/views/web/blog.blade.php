<x-web-layout title="Blog - Luxe Jewels">
		...
		<div class="hero text-center d-flex justify-content-center align-items-center py-5">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
								<h1 class="display-4 text-white mt-4">BLOG</h1>
								<h2 class="text-white mt-4">Your Journey to Luxury, Our Expertise</h2>
								<p class="mb-4 mt-4 lead">Welcome to our blog, your go-to source for all things luxury. Discover the latest trends, style tips, and behind-the-scenes insights from the world of fine jewelry. From gemstone education to personalized styling advice, we've got you covered.</p>
