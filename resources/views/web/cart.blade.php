                      ...
                      <tbody>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="build/assets/images/earring.webp" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">Earring</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
                        ...
                        <tr>
                          <td class="product-thumbnail">
                            <img src="build/assets/images/bangle.webp" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">Bangle</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
                            <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
