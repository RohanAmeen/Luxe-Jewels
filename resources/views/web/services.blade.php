<x-web-layout title="Services - Luxe Jewels">
<div class="hero text-center d-flex justify-content-center align-items-center py-5">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
								<h1 class="display-4 text-white mt-4">SERVICES</h1>
								<h2 class="text-white mt-4"> Elevate Your Experience</h2>
								<p class="mb-4 mt-4 lead">Discover the difference of exceptional service. With our 24/7 support, you'll always have access to the help you need. Let us handle the complexities, so you can focus on what matters most.</p>
